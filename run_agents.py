...
DRY_RUN_RESEARCH = {
    ...
    "trends": [
        ...
        },
        {
            "category": "カラー",
            "title": "桜色・ミルキーピンク",
            "description": "春らしい淡いピンク系。桜カラー・ベビーピンク・乳白色が人気急上昇中。GW前の需要が高い。",
            "sources": [],
            "keywords": ["桜ネイル", "ミルキーピンク", "春ネイル", "ニュアンスカラー"],
            "relevance_score": 5,
        },
        {
            "category": "技法",
            "title": "グラスネイル（Glass Nails）",
            "description": "韓国発。カラーホイルを封入した透明感あるデザイン。春の光と相性抜群。",
            "sources": [],
        ...
        {
            "category": "デザイン",
            "title": "フラワーネイル（押し花・花柄）",
            "description": "春定番の花モチーフ。押し花封入や手描き花柄が今年もトレンド上位。母の日需要にも対応。",
            "sources": [],
            "keywords": ["フラワーネイル", "押し花", "春", "母の日"],
            "relevance_score": 4,
        },
        {
            "category": "カラー",
            "title": "ミントグリーン・ラベンダー",
            "description": "春夏の爽やかカラー。淡いグリーン系とラベンダーが今季注目。若い世代を中心に人気。",
            "sources": [],
            "keywords": ["ミントネイル", "ラベンダーネイル", "春夏", "くすみカラー"],
            "relevance_score": 3,
        },
    ],
    "hot_colors": ["桜ピンク", "ミルキーホワイト", "ミントグリーン", "ラベンダー", "コーラルピンク"],
    "hot_techniques": ["オーロラパウダー", "押し花封入", "フラワーアート", "グラスネイル"],
    "summary_for_next_agent": "今週の最大トレンドはオーロラネイルと桜カラー。春本番・GW前の需要増加期。フラワーモチーフと淡い春カラーが中心。母の日（5月）に向けた準備も開始すべきタイミング。",
}
